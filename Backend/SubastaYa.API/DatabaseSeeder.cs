    ...
    public static class DatabaseSeeder
    {
        public static async Task SeedAsync(IServiceProvider services)
        {
            ...
            var auctionStandard = new Auction
            {
                ...
                ImageUrl = "https://images.unsplash.com/photo-1422049091443-449e59456bab?auto=format&fit=crop&fm=jpg&q=85&w=1000",
                BasePrice = 40000,
            ...
            var auctionCritic = new Auction
            {
                ...
                ImageUrl = "https://images.unsplash.com/photo-1704977733553-e3d7d92c4d66?auto=format&fit=crop&fm=jpg&q=85&w=1000",
                BasePrice = 5000,
            ...
            var auctionUpcoming = new Auction
            {
                ...
                ImageUrl = "https://images.unsplash.com/photo-1771015310937-6754da25e49a?auto=format&fit=crop&fm=jpg&q=85&w=1000",
                BasePrice = 80000,
            ...
            var auctionExpiredWithWinner = new Auction
            {
                ...
                ImageUrl = "https://images.unsplash.com/photo-1708662474101-b0533ce3121a?auto=format&fit=crop&fm=jpg&q=85&w=1000",
                BasePrice = 10000,
            ...
            var auctionExpiredDeserted = new Auction
            {
                ...
                ImageUrl = "https://images.unsplash.com/photo-1551028719-00167b16eac5?auto=format&fit=crop&fm=jpg&q=85&w=1000",
                BasePrice = 30000,
