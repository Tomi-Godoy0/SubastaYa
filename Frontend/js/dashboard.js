...
async function cargarBilletera() {
    ...
    try {
        ...
        const elementoDisponible =
            document.getElementById(
                "saldo-disponible"
            );


        const elementoRetenido =
            document.getElementById(
                "saldo-retenido"
            );
        ...
        if (elementoDisponible) {
            ...
            elementoDisponible.textContent =
        ...
        if (elementoRetenido) {
            ...
            elementoRetenido.textContent =
                formatearPrecio(retenido);
...
async function cargarHistorialMovimientos() {
    ...
    if (!tbody) {
        ...
        console.warn(
            "No existe #tabla-movimientos en el HTML."
        );
...
function obtenerDescripcionMovimiento(
    movimiento
) {
    ...
    if (
        tipo.includes("refund") ||
        tipo.includes("reintegro")
    ) {
        return "Reintegro";
    }
...
function mostrarErrorMovimientos(
    mensaje
) {
